                    ...
                    <div className='flex items-center justify-center'>
                        <form className='flex flex-col w-[400px] h-full gap-3 items-center justify-center' onSubmit={handleSubmit}>
                            ...
                            <div className='flex flex-col gap-2'>
                                <button className='bg-[#632379] w-80 h-11 text-white px-3 py-2 font-medium shadow-md transition duration-300 hover:bg-[#7a2c94] hover:shadow-lg active:scale-95  rounded-3xl border border-transparent' style={{ borderRadius: '9px' }}>Login</button>
                                <p>Are you New? <Link to="/register" className='text-blue-500 cursor-pointer'>Create a Account</Link></p>
                            </div>
                        </form>
                    </div>
                </div>
